(function () {
  ...
  const modeContent = {
    ...
    anatomy: {
      ...
      titleEn: "Explore each\nexternal part.",
      titleTh: "สำรวจ\nชิ้นส่วนภายนอก",
      copyEn: "Select a component to see its position and role in the pen.",
      copyTh: "เลือกชิ้นส่วนเพื่อดูตำแหน่งและหน้าที่ของแต่ละส่วนในปากกา",
    ...
    exploded: {
      ...
      titleEn: "Start with\nthe structure.",
      titleTh: "เริ่มจาก\nโครงสร้าง",
      copyEn: "Follow the external components from the pusher to the cone.",
      copyTh: "สำรวจส่วนประกอบภายนอกตั้งแต่ปุ่มกดจนถึงส่วนปลายปากกา",
